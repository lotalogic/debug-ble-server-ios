...
class VivaldiS1Service(Service):
    ...
    ESPRESSO_SVC_UUID = "00000000-0000-0000-0000-0000feedc0de"
...
class PowerControlCharacteristic(Characteristic):
    uuid = "00000000-0000-0000-000f-00dc0de00001"
    ...
    def ReadValue(self, options):
        ...
        res = None
        self.value = bytearray("kikoo", encoding="utf8")
        # try:
...
def main():
    ...
    adapter_props.Set(ADAPTER_IFACE, 'Discoverable', True)
